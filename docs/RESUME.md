...
| 時期            | 経歴                                                    |
| --------------- | ------------------------------------------------------- |
| 2022/04~現在    | クラスター株式会社 ソフトウェアエンジニア |
...
- Storybook, Jestを使ったテストコード開発
  - 業務でStorybook, Jestを使ってテストを書いています
- C#/Unity
...
ソフトウェアエンジニアとして、[cluster.mu](https://cluster.mu/) の開発や社内ツールの開発を行なっています。
